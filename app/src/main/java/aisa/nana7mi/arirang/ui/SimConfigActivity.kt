...
import aisa.nana7mi.arirang.model.SimInfo
import aisa.nana7mi.arirang.ui.item.SimInfoSlotView
...
class SimConfigActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val systemSimInfoList = getSystemSimInfoList();
        val container = findViewById<LinearLayout>(R.id.sim_slot_container)
        val slotCount = systemSimInfoList.size
        ...
        repeat(slotCount) { index ->
            ...
            slotView.setSimInfo(systemSimInfoList[index])
